...
interface IRWAOracleSetterInterface extends ethers.utils.Interface {
  functions: {
...
export class IRWAOracleSetter extends BaseContract {
  ...
  interface: IRWAOracleSetterInterface;
