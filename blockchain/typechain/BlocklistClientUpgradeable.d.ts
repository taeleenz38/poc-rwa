...
interface BlocklistClientUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class BlocklistClientUpgradeable extends BaseContract {
  ...
  interface: BlocklistClientUpgradeableInterface;
