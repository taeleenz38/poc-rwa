...
import type { RWAHub, RWAHubInterface } from "../RWAHub";
...
export class RWAHub__factory {
  static readonly abi = _abi;
  static createInterface(): RWAHubInterface {
    return new utils.Interface(_abi) as RWAHubInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RWAHub {
    return new Contract(address, _abi, signerOrProvider) as RWAHub;
  }
}
