...
import type {
  ...
  RWAHubOffChainRedemptionsInterface,
} from "../RWAHubOffChainRedemptions";
...
export class RWAHubOffChainRedemptions__factory {
  static readonly abi = _abi;
  static createInterface(): RWAHubOffChainRedemptionsInterface {
    return new utils.Interface(_abi) as RWAHubOffChainRedemptionsInterface;
  }
  static connect(
    address: string,
