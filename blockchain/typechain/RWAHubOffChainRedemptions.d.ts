...
interface RWAHubOffChainRedemptionsInterface extends ethers.utils.Interface {
  functions: {
...
export class RWAHubOffChainRedemptions extends BaseContract {
  ...
  interface: RWAHubOffChainRedemptionsInterface;
