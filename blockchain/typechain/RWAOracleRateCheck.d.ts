...
interface RWAOracleRateCheckInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    "RWAPriceSet(int256,int256,uint256)": EventFragment;
    "RoleAdminChanged(bytes32,bytes32,bytes32)": EventFragment;
    "RoleGranted(bytes32,address,address)": EventFragment;
    "RoleRevoked(bytes32,address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "RWAPriceSet"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleAdminChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleGranted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleRevoked"): EventFragment;
}

export type RWAPriceSetEvent = TypedEvent<
...
export class RWAOracleRateCheck extends BaseContract {
  ...
  interface: RWAOracleRateCheckInterface;
  ...
  functions: {
    ...
    getPriceData(overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
  ...
  filters: {
    "RWAPriceSet(int256,int256,uint256)"(
      oldPrice?: null,
      newPrice?: null,
      timestamp?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber, BigNumber],
      { oldPrice: BigNumber; newPrice: BigNumber; timestamp: BigNumber }
    >;
