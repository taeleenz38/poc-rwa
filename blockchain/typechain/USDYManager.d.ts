...
interface USDYManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "TIMESTAMP_SETTER_ROLE()": FunctionFragment;
    ...
    "depositIdToClaimableTimestamp(bytes32)": FunctionFragment;
    ...
    "minimumOffChainRedemptionAmount()": FunctionFragment;
    "minimumRedemptionAmount()": FunctionFragment;
    "mintFee()": FunctionFragment;
    "offChainRedemptionPaused()": FunctionFragment;
    ...
    "setClaimableTimestamp(uint256,bytes32[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "TIMESTAMP_SETTER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "depositIdToClaimableTimestamp",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "minimumOffChainRedemptionAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "offChainRedemptionPaused",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setClaimableTimestamp",
    values: [BigNumberish, BytesLike[]]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ClaimableTimestampSet(uint256,bytes32)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ClaimableTimestampSet"): EventFragment;
...
export type ClaimableTimestampSetEvent = TypedEvent<
  [BigNumber, string] & { claimTimestamp: BigNumber; depositId: string }
>;
...
export class USDYManager extends BaseContract {
  ...
  interface: USDYManagerInterface;
  ...
  functions: {
    ...
    TIMESTAMP_SETTER_ROLE(overrides?: CallOverrides): Promise<[string]>;
    ...
    minimumOffChainRedemptionAmount(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    offChainRedemptionPaused(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    setOffChainRedemptionMinimum(
      _minimumOffChainRedemptionAmount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "ClaimableTimestampSet(uint256,bytes32)"(
      claimTimestamp?: BigNumberish | null,
      depositId?: BytesLike | null
    ): TypedEventFilter<
      [BigNumber, string],
      { claimTimestamp: BigNumber; depositId: string }
    >;
  ...
  estimateGas: {
    ...
    TIMESTAMP_SETTER_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    offChainRedemptionPaused(overrides?: CallOverrides): Promise<BigNumber>;
