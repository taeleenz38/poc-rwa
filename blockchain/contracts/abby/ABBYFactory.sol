...
contract ABBYFactory is IMulticall {
  ...
  function deployABBY(
    ...
    abbyProxied.grantRole(PAUSER_ROLE, guardian);

    abbyProxied.revokeRole(MINTER_ROLE, address(this));
    abbyProxied.revokeRole(PAUSER_ROLE, address(this));
    abbyProxied.revokeRole(DEFAULT_ADMIN_ROLE, address(this));
  ...
  modifier onlyGuardian() {
    require(msg.sender == guardian, "ABBYFactory: You are not the Guardian");
    _;
  }
}
