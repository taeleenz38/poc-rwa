    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 z-50 flex justify-center items-center">
      <div className="p-6 rounded-lg text-gray bg-white shadow-md shadow-white w-1/3">
        ...
        <div className="text-center px-8  mb-8 ">
          {collateralType === "AUDC" ? "Please enter the amount of AUDC you wish to approve for the AUDY Manager to spend for a given redemption ID." : "Please enter the amount of USDC you wish to approve for the HYF Manager to spend for a given Redemption ID."}
        </div>
        <div className="mb-4">
          <InputField
            label="Redemption ID:"
