...
const HomepageCard: React.FC<HomepageCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-center w-[350px] p-10 rounded-xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
      <Image src={src} alt={title} width={300} height={300} />
      <h2 className="text-xl font-bold mt-10 text-primary">{title}</h2>
