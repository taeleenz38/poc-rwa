  ...
  return (
    <div>
      ...
      <div className="flex justify-evenly w-[1100px] gap-12 mb-12 mx-auto">
        ...
        <FundInfoCard
          src="/stability.png"
          title="Trusted Exposure"
          description="Shield your investment with exposure to high-quality Asian stocks"
        />
      </div>
      <div className="flex justify-evenly w-[1100px] gap-12 mb-16 mx-auto">
        ...
        <FundInfoCard
          ...
          description="Watch your EQV token value grow"
        />
      </div>
    </div>
  );
